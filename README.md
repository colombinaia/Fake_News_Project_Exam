...
## AI Usage Disclosure
In accordance with KU’s official policy on generative AI, I have utilized AI tools (Gemini 3 Flash) in the following ways:

### **AI Tool Usage:**
- **Concept Clarifications:** Assistance in understanding the mathematical differences between Bag-of-Words and TF-IDF weighting, and the margin-maximization logic of Linear SVMs.
- **Text Formulation and Grammar:** AI assisted in refining the professional tone of the report.
- **Code Refinements & Debugging:** Assistance in guidance for optimizing the Pandas chunking logic for the 995K dataset and debugging LaTeX rendering issues for special characters in code snippets.
- **Analysis Assistance:** AI served as a sounding board for interpreting the high False Positive rate encountered during cross-domain evaluation on the LIAR dataset.

### **Reflection on AI-Generated Content:**
- **Verification:** All technical outputs, including model F1-scores, confusion matrices, and data statistics, were manually generated by my own code execution. AI was used to help articulate the reasoning behind these results (e.g., sample bias), but the data itself is original.
- **Modifications:** AI suggestions were heavily edited to ensure my view remained consistent and that the analysis accurately reflected specific artefacts (such as the `num` token) found during EDA.
